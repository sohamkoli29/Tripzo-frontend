      ...
      const options = {
        ...
        handler: async (response) => {
          try {
            ...
            setError(
              "Payment verified by Razorpay but confirmation failed: " +
                err.message,
            );
          } finally {
            setPaying(false);
      ...
      <div className="max-w-md mx-auto text-center space-y-6 pt-12">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5 text-left space-y-3">
          {[
            ...
            {
              label: "Amount",
              value: "₹" + parseFloat(ride?.fare || 0).toFixed(2),
            },
            ...
            <div
              key={item.label}
              className="flex justify-between text-sm border-b border-gray-800 pb-2 last:border-0 last:pb-0"
            >
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div
              key={m.label}
              className="bg-gray-800 rounded-xl p-3 flex items-center gap-2"
            >
