  ...
  return (
    <div className="space-y-8">
            ...
            {driverSuccess ? (
              <div className="text-center space-y-3 py-4">
                ...
                <p className="text-gray-400 text-sm">
                  Your account has been upgraded. Head to the Driver Dashboard
                  to start earning.
                </p>
              </div>
            ) : (
                  ...
                  {[
                    {
                      icon: "💰",
                      title: "Earn More",
                      desc: "Set your own hours and maximize your income",
                    },
                    {
                      icon: "🗺️",
                      title: "Drive Anywhere",
                      desc: "Accept rides in your city on your terms",
                    },
                    {
                      icon: "⚡",
                      title: "Instant Payouts",
                      desc: "Get paid quickly after every completed ride",
                    },
                    {
                      icon: "🛡️",
                      title: "Full Support",
                      desc: "24/7 driver support whenever you need help",
                    },
                  ].map((b) => (
                    <div
                      key={b.title}
                      className="flex items-start gap-3 bg-gray-800 rounded-xl p-4"
                    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link
          href="/dashboard/book"
          className="bg-yellow-400 text-black font-bold px-5 py-2.5 rounded-xl hover:bg-yellow-300 transition text-sm w-full sm:w-auto text-center"
        >
          + Book a Ride
        </Link>
      </div>
      ...
      {/* Active Ride Banner */}
      {activeRide && (
        <div className="bg-yellow-400/10 border border-yellow-400/30 rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <Link
            ...
            className="bg-yellow-400 text-black text-sm font-bold px-4 py-2 rounded-xl hover:bg-yellow-300 transition text-center"
          >
            Track Ride
          </Link>
        </div>
            ...
            >
              ...
              <div>
                ...
                <p
                  className={
                    "text-xs mt-0.5 " +
                    (action.primary ? "text-black/60" : "text-gray-500")
                  }
                >
                  {action.desc}
                </p>
